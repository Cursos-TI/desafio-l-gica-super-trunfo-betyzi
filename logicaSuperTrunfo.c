...
int main() {
   ...
   //Criando o menu usando o Switch, fazendo cases para comparar apenas o tributo que for pedido (Adicionei alguns emojis nos codigos onde deve aparecer os resultados :) )
